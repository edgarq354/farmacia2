...
class Chat extends Database
{
	...
	public static function get_chat_usuario_conductor($id_usuario,$id_conductor)
   {$resultado=-1;
   	try{
			$consulta="SELECT * from chat where id_usuario=? and id_conductor=? ";
			$comando=parent::getInstance()->getDb()->prepare($consulta);
	 		$comando->execute(array($id_usuario,$id_conductor));
